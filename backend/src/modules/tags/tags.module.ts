...
@Module({
  imports: [TypeOrmModule.forFeature([Tag, ConversationTag, CustomerTag]), ConversationsModule],
  providers: [TagsService],
  controllers: [TagsController, ConversationTagsController, CustomerTagsController],
  exports: [TagsService],
})
